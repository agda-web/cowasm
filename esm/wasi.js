import { Buffer } from './core/wasi-js/buffer-interop.js';
import debug from './node_modules/.pnpm/debug@4.3.4/node_modules/debug/src/browser.js';
import { WASIError } from './types.js';
import toBuffer from './node_modules/.pnpm/typedarray-to-buffer@4.0.0/node_modules/typedarray-to-buffer/index.js';
import { WASI_STDIN_FILENO, WASI_FILETYPE_CHARACTER_DEVICE, WASI_STDOUT_FILENO, WASI_STDERR_FILENO, WASI_FILETYPE_DIRECTORY, RIGHTS_DIRECTORY_BASE, RIGHTS_DIRECTORY_INHERITING, WASI_ESUCCESS, WASI_CLOCK_REALTIME, WASI_CLOCK_THREAD_CPUTIME_ID, WASI_CLOCK_PROCESS_CPUTIME_ID, WASI_CLOCK_MONOTONIC, WASI_EINVAL, WASI_EVENTTYPE_FD_WRITE, WASI_ENOSYS, WASI_EVENTTYPE_FD_READ, WASI_EVENTTYPE_CLOCK, SIGNAL_MAP, WASI_FILETYPE_SOCKET_STREAM, WASI_RIGHT_FD_DATASYNC, WASI_RIGHT_FD_READ, WASI_RIGHT_FD_SYNC, WASI_RIGHT_FD_ADVISE, WASI_RIGHT_FD_FILESTAT_GET, WASI_RIGHT_POLL_FD_READWRITE, WASI_RIGHT_FD_WRITE, WASI_RIGHT_FD_FDSTAT_SET_FLAGS, ERROR_MAP, WASI_RIGHT_FD_ALLOCATE, WASI_EPERM, WASI_RIGHT_FD_FILESTAT_SET_SIZE, WASI_RIGHT_FD_FILESTAT_SET_TIMES, WASI_FILESTAT_SET_ATIM, WASI_FILESTAT_SET_ATIM_NOW, WASI_FILESTAT_SET_MTIM, WASI_FILESTAT_SET_MTIM_NOW, WASI_PREOPENTYPE_DIR, WASI_RIGHT_FD_SEEK, WASI_FILETYPE_REGULAR_FILE, WASI_RIGHT_FD_READDIR, WASI_FILETYPE_UNKNOWN, WASI_FILETYPE_SYMBOLIC_LINK, WASI_FILETYPE_BLOCK_DEVICE, WASI_WHENCE_SET, WASI_WHENCE_END, WASI_WHENCE_CUR, WASI_RIGHT_FD_TELL, WASI_RIGHT_PATH_CREATE_DIRECTORY, WASI_RIGHT_PATH_FILESTAT_GET, WASI_RIGHT_PATH_FILESTAT_SET_TIMES, WASI_RIGHT_PATH_LINK_SOURCE, WASI_RIGHT_PATH_LINK_TARGET, WASI_RIGHT_PATH_OPEN, WASI_O_CREAT, WASI_RIGHT_PATH_CREATE_FILE, WASI_O_DIRECTORY, WASI_O_EXCL, WASI_O_TRUNC, WASI_RIGHT_PATH_FILESTAT_SET_SIZE, WASI_FDFLAG_APPEND, WASI_FDFLAG_DSYNC, WASI_FDFLAG_NONBLOCK, WASI_FDFLAG_RSYNC, WASI_FDFLAG_SYNC, WASI_EBADF, WASI_RIGHT_PATH_READLINK, WASI_RIGHT_PATH_REMOVE_DIRECTORY, WASI_RIGHT_PATH_RENAME_SOURCE, WASI_RIGHT_PATH_RENAME_TARGET, WASI_RIGHT_PATH_SYMLINK, WASI_RIGHT_PATH_UNLINK_FILE, RIGHTS_SOCKET_BASE, RIGHTS_SOCKET_INHERITING, RIGHTS_REGULAR_FILE_BASE, RIGHTS_REGULAR_FILE_INHERITING, RIGHTS_TTY_BASE, RIGHTS_TTY_INHERITING, RIGHTS_CHARACTER_DEVICE_BASE, RIGHTS_CHARACTER_DEVICE_INHERITING, RIGHTS_BLOCK_DEVICE_BASE, RIGHTS_BLOCK_DEVICE_INHERITING } from './constants.js';
...
const SOCKET_DEFAULT_RIGHTS = WASI_RIGHT_FD_DATASYNC |
    WASI_RIGHT_FD_READ |
    WASI_RIGHT_FD_WRITE |
    WASI_RIGHT_FD_ADVISE |
    WASI_RIGHT_FD_FILESTAT_GET |
...
class WASI {
    ...
    sleep;
    lastStdin = 0;
    getStdin; // timeout milliseconds is never used
    stdinBuffer;
    sendStdout;
    sendStderr;
    env = {};
        ...
        this.wasiImport = {
            ...
            */
            ...
            fd_filestat_set_times: wrap((fd, stAtim, stMtim, fstflags) => {
                ...
                else if ((fstflags & WASI_FILESTAT_SET_ATIM_NOW) ===
                ...
                else if ((fstflags & WASI_FILESTAT_SET_MTIM_NOW) ===
...
export { SOCKET_DEFAULT_RIGHTS, WASI as default };
